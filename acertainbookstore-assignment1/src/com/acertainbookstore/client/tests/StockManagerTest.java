...
public class StockManagerTest {
	...
	/**
	 * Checks whether the insertion of a book with initialize books worked.
	 *
	 * @throws BookStoreException
	 *             the book store exception
	 */
	...
	/**
	 * Checks whether an insertion of a book with an invalid ISBN is rejected.
	 *
	 * @throws BookStoreException
	 *             the book store exception
	 */
	...
	public void testaddBookInvalidISBN() throws BookStoreException {
		...
		// Add an invalid ISBN.
		booksToAdd.add(
				new ImmutableStockBook(-1, "Harry Potter and Marcos", "JUnit Rowling", (float) 100, 5,
						0, 0, 0, false));
	...
	/**
	 * Checks whether an insertion of a book with an invalid book title is rejected.
	 *
	 * @throws BookStoreException
	 *             the book store exception
	 */
	@Test
	public void testaddBookInvalidBookTitle() throws BookStoreException {
		List<StockBook> booksInStorePreTest = storeManager.getBooks();

		Set<StockBook> booksToAdd = new HashSet<StockBook>();

		// Add a valid book title.
		booksToAdd.add(new ImmutableStockBook(123, "Harry Potter and Vivek", "JUnit Rowling", (float) 100, 5,
				0, 0, 0, false));

		// Add an invalid book title.
		booksToAdd.add(
				new ImmutableStockBook(123, "", "JUnit Rowling", (float) 100, 5,
						0, 0, 0, false));
	...
	/**
	 * Checks whether an insertion of a book with an invalid book author is rejected.
	 *
	 * @throws BookStoreException
	 *             the book store exception
	 */
	...
	public void testaddBookInvalidBookAuthor() throws BookStoreException {
		...
		// Add a valid book author.
		booksToAdd.add(new ImmutableStockBook(123, "Harry Potter and Vivek", "JUnit Rowling", (float) 100, 5,
				0, 0, 0, false));

		// Add an invalid ISBN.
		booksToAdd.add(
				new ImmutableStockBook(123, "Harry Potter and Marcos", "", (float) 100, 5,
						0, 0, 0, false));
	...
	/**
	 * Checks whether an insertion of a book with duplicate ISBN is rejected.
	 *
	 * @throws BookStoreException
	 *             the book store exception
	 */
	@Test
	public void testaddBookDuplicateISBN() throws BookStoreException {
		List<StockBook> booksInStorePreTest = storeManager.getBooks();
		...
		// Add a duplicate ISBN.
		booksToAdd.add(
				new ImmutableStockBook(30345650, "Harry Potter and Marcos", "JUnit Rowling", (float) 100, 5,
						0, 0, 0, false));
	...
	public void testGetBooksInDemand() throws BookStoreException {
		...
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 1, "JAVA", "java",
				(float) 300, NUM_COPIES, 0, 0, 0, false));
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 2, "Python", "python",
				(float) 300, NUM_COPIES, 1, 0, 0, true));
		storeManager.addBooks(booksToAdd);

		assertEquals("Python", storeManager.getBooksInDemand().get(0).getTitle());
